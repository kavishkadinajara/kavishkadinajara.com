...
export default function ProjectCard({
  ...
  return (
    ...
    >
      {/* top bar */}
      <div className="absolute top-0 left-0 right-0 h-[2px] rounded-t-xl bg-gradient-to-r from-transparent via-[rgba(14,165,233,0.4)] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
